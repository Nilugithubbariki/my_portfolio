export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/1l0aCG8rB0M3-7LQrQRjdNN4p43TtlUp4/view",
...
export const experiences = [
  {
    ...
    desc: "Proficient in building responsive web applications using React.js, JavaScript (ES6+), Redux for state management, and Thunk for asynchronous operations. Experienced in leveraging Material UI to implement consistent and appealing user interfaces, ensuring high usability and accessibility standards.",
    skills: [
      "React",
       "Javascript",
       "TypeScript",
  ...
  },
  {
    ...
    role: "Front End Developer",
    company: "D Madhok Ventures",
    date: "Sept 2023 - March 2024",
    desc: "Implemented Context API for managing global state, Redux for state management, Developed dynamic and responsive front-end components. Fixed bugs and improved performance.",
    skills: [
      "React",
       "Javascript",
       "TypeScript",
  ...
  },
  {
    ...
    desc: "As an Frontend Developer at FinacPlus, Worked on a (Fintech product) mortgage application used React.js library, Utilized Material UI’s pre-built styles and classes for efficient styling and creating a visually appealing and intuitive user interface. Demonstrated strong analytical and problem-solving abilities, efficiently debugging issues and implementing robust solutions to ensure smooth application functionality.",
    skills: [
     "React",
      "Javascript",
      "TypeScript",
...
export const education = [
  {
    id: 0,
    img: "https://static.wixstatic.com/media/0d05b5_190e5ac6f0fd43eeb757fa7d61179870~mv2.jpeg/v1/fill/w_400,h_300,al_c/0d05b5_190e5ac6f0fd43eeb757fa7d61179870~mv2.jpeg",
    school: "KANDAKHAI(DEGREE) COLLEGE OF SCIENCE & EDUCATION, KANDAKHAI",
    date: "June 2016 - June 2019",
    desc: " Bachelor of Science (B.Sc.) in Physics, Chemistry, and Mathematics from Kandakhai(degree) College of Science & Education,Kandakhai,Odisha Graduated with a solid academic foundation in core scientific principles, focusing on Physics, Chemistry, and Mathematics. Developed strong analytical, problem-solving, and quantitative skills, preparing for diverse challenges in science and technology.",
    degree: "Bsc"
  },
  {
    id: 1,
    img: "https://upload.wikimedia.org/wikipedia/en/2/2b/Council_of_Higher_Secondary_Education%2C_Odisha_logo.png",
    school: "PANCHAYAT COLLEGE OF EDN & TECH, SATAPADA",
    date: "March 2014 - March 2016",
    desc: "I completed my class 12 high school education at Panchayat College of Edn & Tech, Satapada, where I studied Science with Computer Science.",
    degree: "Science"
  },
  {
    id: 2,
    img: "https://upload.wikimedia.org/wikipedia/en/thumb/0/03/Bse.odisha.logo.jpg/180px-Bse.odisha.logo.jpg",
    school: "BUDHIBAR DIAKUDA HIGH SCHOOL, BUDHIBAR",
    date: "Feb 2012 - Feb 2014",
    desc: "I completed my class 10 education at Budhibar Diakuda High School, Budhibar, where I studied Science with Computer Application.",
    degree: "Science"
  },
];
